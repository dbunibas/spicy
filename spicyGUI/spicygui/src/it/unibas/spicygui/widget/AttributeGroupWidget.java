...
public class AttributeGroupWidget extends Widget {

    private IconNodeWidget rootWidget;
    private LabelWidget labelValueWidget;

    public AttributeGroupWidget(Scene scene, Point point) {
        super(scene);
    ...
    private MyGradientLabelWidget creaHeaderWidget(Scene scene) {
        ...
        MyGradientLabelWidget gradientHeaderWidget = new MyGradientLabelWidget(scene, "Group", Color.WHITE, colorEndVMD);

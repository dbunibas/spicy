...
public class FunctionalDependencyWidget extends Widget {

    private IconNodeWidget rootWidget;
    private LabelWidget labelValueWidget;

    public FunctionalDependencyWidget(Scene scene, Point point) {
        super(scene);
    ...
    private MyGradientLabelWidget creaHeaderWidget(Scene scene) {
        ...
        MyGradientLabelWidget gradientHeaderWidget = new MyGradientLabelWidget(scene, "Dep", Color.WHITE, colorEndVMD);
    ...
    private void settaBordoFunction() {
        Color colore = Costanti.getIntermediateColor();

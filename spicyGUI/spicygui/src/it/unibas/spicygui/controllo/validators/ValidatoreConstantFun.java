...
public class ValidatoreConstantFun extends Validator{

    private FormValidation formValidation;
    
    public ValidatoreConstantFun() {
    }
    
    @Override
    public Validator.Result validate(Object arg0) {
        if (arg0.equals(true)) {
            formValidation.setComboBoxState(true);
            formValidation.setTextFieldState(false);

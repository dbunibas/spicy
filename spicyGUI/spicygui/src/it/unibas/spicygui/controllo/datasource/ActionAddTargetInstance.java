...
public class ActionAddTargetInstance extends CallableSystemAction implements Observer {

    private static Log logger = LogFactory.getLog(ActionAddTargetInstance.class);
    private Vista vista;
    private Modello modello;
    private LastActionBean lastActionBean;

    public ActionAddTargetInstance() {
        executeInjection();
        registraAzione();

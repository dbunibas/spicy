...
public class MyPopupProviderDeleteFunc implements PopupMenuProvider, ActionListener {

    private static Log logger = LogFactory.getLog(MyPopupProviderDeleteFunc.class);
    ...
    public MyPopupProviderDeleteFunc(GraphSceneGlassPane graphScene) {
    ...
    private void deleteAll() {
        ...
        CaratteristicheWidgetInterFunction caratteristicheWidget = (CaratteristicheWidgetInterFunction) mainLayer.getChildConstraint(rootWidget);
        ...
        graphScene.removeFunction(rootWidget);
        graphScene.removeFunction(caratteristicheWidget.getWidgetBarra());

...
public class MyPopupProviderConnectionChainComposition implements PopupMenuProvider, ActionListener {

    private static Log logger = LogFactory.getLog(MyPopupProviderConnectionChainComposition.class);
    ...
    public MyPopupProviderConnectionChainComposition(Scene scene) {
        this.scene = scene;
        createPopupMenu();
    }

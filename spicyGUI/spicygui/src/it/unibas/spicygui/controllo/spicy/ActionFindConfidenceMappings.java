...
public class ActionFindConfidenceMappings extends CallableSystemAction implements Observer {
    ...
    public ActionFindConfidenceMappings() {
        executeInjection();
    ...
    public void performAction() {
        ...
        config.setProperty(IComputeQuality.class.getSimpleName(), "it.unibas.spicy.findmappings.strategies.computequality.ComputeQualityMatchAverage");
    ...
    public String getName() {
        return NbBundle.getMessage(Costanti.class, Costanti.ACTION_FIND_MAPPINGS_ON_CORRESPONDENCES);
    }

...
public class ActionViewRankedTransformations extends CallableSystemAction implements Observer {

    private LastActionBean lastActionBean;
    private Modello modello;

    public ActionViewRankedTransformations() {
        executeInjection();
    ...
    public void performAction() {
        ...
        RankedTransformationsTopComponent win = scenario.getRankedTransformationsTopComponent();
        win.updateTable();
        win.open();
        win.requestActive();
    }
    ...
    public void update(Observable o, Object stato) {
        if (stato.equals(LastActionBean.RANK_TRANSFORMATIONS)) {
    ...
    public String getName() {
        return NbBundle.getMessage(Costanti.class, Costanti.ACTION_VIEW_RANKED_TRANSFORMATIONS);
    }
    ...
    protected String iconResource() {
        return Costanti.ICONA_VIEW_RANKED_TRANSFORMATIONS;
    }

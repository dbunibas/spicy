...
public class ActionViewTGDs extends CallableSystemAction implements Observer {
    ...
    public ActionViewTGDs() {
        executeInjection();
        this.putValue(SHORT_DESCRIPTION, NbBundle.getMessage(Costanti.class, Costanti.ACTION_VIEW_TGD_LIST_TOOLTIP));
...
//        tgdCorrespondencesTopComponent.requestActive();
    ...
    public String getName() {
        return NbBundle.getMessage(Costanti.class, Costanti.ACTION_VIEW_TGD_LIST);
    }

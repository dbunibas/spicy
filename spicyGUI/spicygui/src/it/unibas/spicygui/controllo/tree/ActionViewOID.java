...
public class ActionViewOID extends AbstractAction {

    private static Log logger = LogFactory.getLog(ActionViewOID.class);
    private JTree albero;
    private boolean visualizzati;

    public ActionViewOID(JTree albero) {
        this.albero = albero;
        this.putValue(NAME, NbBundle.getMessage(Costanti.class, Costanti.ACTION_VIEW_OIDs));
    }

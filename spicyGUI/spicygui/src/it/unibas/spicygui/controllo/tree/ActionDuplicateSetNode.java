...
public class ActionDuplicateSetNode extends AbstractAction {
    ...
    public ActionDuplicateSetNode(JLayeredPaneCorrespondences jLayeredPane, JTree jTree, IDataSourceProxy dataSource) {
        this.executeInjection();
        this.jLayeredPane = jLayeredPane;
        this.jTree = jTree;
        this.dataSource = dataSource;
        this.putValue(NAME, NbBundle.getMessage(Costanti.class, Costanti.ACTION_DUPLICATE_SET_NODE));
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        recreateTree();
            ...
            DialogDisplayer.getDefault().notify(new NotifyDescriptor.Message(NbBundle.getMessage(Costanti.class, Costanti.DUPLICATION_NO) + ": " + iae.getMessage() , DialogDescriptor.ERROR_MESSAGE));
        }
    }

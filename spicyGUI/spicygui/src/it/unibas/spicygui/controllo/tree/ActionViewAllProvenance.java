...
public class ActionViewAllProvenance extends AbstractAction {

    private static Log logger = LogFactory.getLog(ActionViewAllProvenance.class);
    private JTree albero;
    private boolean visualizzati;

    public ActionViewAllProvenance(JTree albero) {
        this.albero = albero;
        this.putValue(NAME, NbBundle.getMessage(Costanti.class, Costanti.ACTION_VIEW_ALL_PROVENANCES));
    }

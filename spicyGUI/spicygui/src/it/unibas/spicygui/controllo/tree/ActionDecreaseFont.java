...
public class ActionDecreaseFont extends AbstractAction {

    private static Log logger = LogFactory.getLog(ActionIncreaseFont.class);
    private JTextArea textArea;

    public ActionDecreaseFont(JTextArea textArea) {
        this.textArea = textArea;
        this.putValue(NAME, NbBundle.getMessage(Costanti.class, Costanti.ACTION_DECREASE_FONT));
    }

...
public class ComputeQualityMatchAverage implements IComputeQuality, Comparator<AnnotatedMappingTask> {
...
//        mappingTaskSolver.solve(mappingTask);
        ...
        for (ValueCorrespondence correspondence : correspondences) {
            totalSimilarity += correspondence.getConfidence();
        }
        double avgSimilarity = totalSimilarity / correspondences.size();
        annotatedMappingTask.setQualityMeasure(avgSimilarity);
    }

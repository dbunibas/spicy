...
public class AggregateAsHarmonicMean implements IAggregateSimilarityFeatures{
        
    public double calculateAggregateValue(List<SimilarityFeature> features) {
        double sumOfValues = 0.0;
        double sumOfWeights = 0.0;
        for(SimilarityFeature feature : features){
            sumOfValues += (1.0 / feature.getValue()) * feature.getWeight();
            sumOfWeights += feature.getWeight();
        }
        return (sumOfWeights / sumOfValues);
    }
}

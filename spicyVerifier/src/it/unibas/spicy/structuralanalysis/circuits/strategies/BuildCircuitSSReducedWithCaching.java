...
public class BuildCircuitSSReducedWithCaching implements IBuildCircuitStrategy {
    ...
    public BuildCircuitSSReducedWithCaching() {}
    
    public BuildCircuitSSReducedWithCaching(IFindNodesToExclude excluder, double multiplyingFactorForElements,
...
//        Circuit circuit = buildCircuit(schema, similarityCheck, excludeNodes); // WITHOUT CACHING
    ...
    private Circuit buildCircuit(INode schema, SimilarityCheck similarityCheck, boolean excludeNodes) {
        ...
        try {
            ...
            BuildCircuitSSReducedWithCachingVisitor visitor = new BuildCircuitSSReducedWithCachingVisitor(multiplyingFactorForElements,
...
class BuildCircuitSSReducedWithCachingVisitor implements INodeVisitor {
    ...
    public BuildCircuitSSReducedWithCachingVisitor(double multiplyingFactorForElements, double multiplyingFactorForStatisticElements, double levelResistance,
...
class MatrixGeneratorReducedWithCachingVisitor implements ICircuitVisitor {

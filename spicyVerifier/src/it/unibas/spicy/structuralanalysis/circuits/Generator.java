...
public class Generator extends AbstractCircuitElement {
    
    public Generator(int id, String description, double value, INode schemaNode, CircuitNode sourceNode, CircuitNode targetNode) {
        super(id, description, value, schemaNode, sourceNode, targetNode);
   }

    public String getType() {
        return ICircuitElement.GENERATOR;
    }

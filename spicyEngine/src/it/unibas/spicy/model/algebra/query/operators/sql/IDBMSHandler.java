...
public interface IDBMSHandler {

    public String generateSortArrayFunction();

    public String skolemString(SkolemFunctionGenerator generator, MappingTask mappingTask);

    public String getAutoGeneratedColumnType();

    public String forceCast(String value, String targetType);

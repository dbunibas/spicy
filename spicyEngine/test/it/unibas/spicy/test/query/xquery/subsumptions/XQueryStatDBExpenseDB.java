...
public class XQueryStatDBExpenseDB extends XQueryTest {
    ...
    protected void initFileReferences() {
        sourceInstanceXMLFile = this.getClass().getResource(References.statDBXMLInstance).getPath();
//        expectedInstanceFile = this.getClass().getResource(References.expenseDBXMLExpectedInstance).getPath();
    }

...
package it.unibas.spicy.test.query.xquery.coverage;
...
public class XQueryCoverageBig2 extends XQueryTest {
    ...
    protected void initFileReferences() {
        sourceInstanceXMLFile = this.getClass().getResource(References.coverageBig2XMLInstance).getPath();
        expectedInstanceFile = this.getClass().getResource(References.coverageBig2XMLExpectedInstance).getPath();
    }

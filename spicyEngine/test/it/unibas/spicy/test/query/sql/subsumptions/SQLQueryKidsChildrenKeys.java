...
public class SQLQueryKidsChildrenKeys extends SQLQueryTest {

    protected void setUp() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.kidsPresentsChildrenDBKeys).toURI()).getAbsolutePath();
    ...
    protected void initFileReferences() {
        ...
        expectedInstanceFile = this.getClass().getResource(References.kidsPresentsKeysExpectedInstance).getPath();
    }
}

...
public class SQLQueryEgdMorris extends SQLQueryTest {
    ...
    protected void initFileReferences() {
        sourceSQLScriptReader = new InputStreamReader(this.getClass().getResourceAsStream(References.morrisSourceSQLScriptSchema));
        sourceInstanceSQLScriptReader = new InputStreamReader(this.getClass().getResourceAsStream(References.morrisSourceSQLScriptInstances));
        targetSQLScriptReader = new InputStreamReader(this.getClass().getResourceAsStream(References.morrisTargetSQLScriptSchema));
        expectedInstanceFile = this.getClass().getResource(References.morrisExpectedInstance).getPath();
    }
}

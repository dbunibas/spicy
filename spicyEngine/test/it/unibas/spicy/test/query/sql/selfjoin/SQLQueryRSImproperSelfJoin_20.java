...
public class SQLQueryRSImproperSelfJoin_20 extends SQLQueryTest {
    ...
    protected void initFileReferences() {
        ...
        sourceInstanceSQLScriptReader = new InputStreamReader(this.getClass().getResourceAsStream(References.rsImproperSelfJoinSourceSQLScriptInstances_20));
        ...
        expectedInstanceFile = this.getClass().getResource(References.rsImproperSelfJoinExpectedInstance_20).getPath();
    }
}

...
public class SQLQueryRSImproperSelfJoin_128 extends SQLQueryTest {
    ...
    protected void initFileReferences() {
        ...
        sourceInstanceSQLScriptReader = new InputStreamReader(this.getClass().getResourceAsStream(References.rsImproperSelfJoinSourceSQLScriptInstances_128));
        ...
        expectedInstanceFile = this.getClass().getResource(References.rsImproperSelfJoinExpectedInstance_128).getPath();
    }
}

...
public class SQLQueryKidsChildrenSelfJoinKeys extends SQLQueryTest {

    protected void setUp() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.kidsPresentsChildrenDBSelfJoinKeys).toURI()).getAbsolutePath();
    ...
    protected void initFileReferences() {
        ...
        expectedInstanceFile = this.getClass().getResource(References.kidsPresentsSelfJoinKeysExpectedInstance).getPath();
    }
}

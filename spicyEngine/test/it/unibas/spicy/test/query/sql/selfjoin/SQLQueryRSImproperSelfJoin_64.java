...
public class SQLQueryRSImproperSelfJoin_64 extends SQLQueryTest {
    ...
    protected void initFileReferences() {
        ...
        sourceInstanceSQLScriptReader = new InputStreamReader(this.getClass().getResourceAsStream(References.rsImproperSelfJoinSourceSQLScriptInstances_64));
        ...
        expectedInstanceFile = this.getClass().getResource(References.rsImproperSelfJoinExpectedInstance_64).getPath();
    }
}

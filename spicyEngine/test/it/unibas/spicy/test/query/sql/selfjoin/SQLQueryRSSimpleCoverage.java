...
public class SQLQueryRSSimpleCoverage extends SQLQueryTest {
    ...
    protected void initFileReferences() {
        ...
        sourceInstanceSQLScriptReader = new InputStreamReader(this.getClass().getResourceAsStream(References.rsSimpleCoverageSourceSQLScriptInstances));
        ...
        expectedInstanceFile = this.getClass().getResource(References.rsSimpleCoverageExpectedInstance).getPath();
    }
}

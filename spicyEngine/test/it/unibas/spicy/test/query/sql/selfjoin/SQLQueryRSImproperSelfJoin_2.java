...
public class SQLQueryRSImproperSelfJoin_2 extends SQLQueryTest {
    ...
    protected void initFileReferences() {
        ...
        sourceInstanceSQLScriptReader = new InputStreamReader(this.getClass().getResourceAsStream(References.rsImproperSelfJoinSourceSQLScriptInstances_2));
        ...
        expectedInstanceFile = this.getClass().getResource(References.rsImproperSelfJoinExpectedInstance_2).getPath();
    }
}

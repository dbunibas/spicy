...
public class SQLQueryRSSimpleCoverage_20 extends SQLQueryTest {
    ...
    protected void initFileReferences() {
        ...
        sourceInstanceSQLScriptReader = new InputStreamReader(this.getClass().getResourceAsStream(References.rsSimpleCoverageSourceSQLScriptInstances_20));
        ...
        expectedInstanceFile = this.getClass().getResource(References.rsSimpleCoverageExpectedInstance_20).getPath();
    }
}

...
public class SQLQueryRSSimpleCoverage_150 extends SQLQueryTest {
    ...
    protected void initFileReferences() {
        ...
        sourceInstanceSQLScriptReader = new InputStreamReader(this.getClass().getResourceAsStream(References.rsSimpleCoverageSourceSQLScriptInstances_150));
        ...
        expectedInstanceFile = this.getClass().getResource(References.rsSimpleCoverageExpectedInstance_150).getPath();
    }
}

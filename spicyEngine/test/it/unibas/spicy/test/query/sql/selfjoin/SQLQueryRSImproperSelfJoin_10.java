...
public class SQLQueryRSImproperSelfJoin_10 extends SQLQueryTest {
    ...
    protected void initFileReferences() {
        ...
        sourceInstanceSQLScriptReader = new InputStreamReader(this.getClass().getResourceAsStream(References.rsImproperSelfJoinSourceSQLScriptInstances_10));
        ...
        expectedInstanceFile = this.getClass().getResource(References.rsImproperSelfJoinExpectedInstance_10).getPath();
    }
}

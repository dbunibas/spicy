...
public class SQLQueryNegation3 extends SQLQueryTest {

    protected void setUp() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.negationExample3).toURI()).getAbsolutePath();
    ...
    protected void initFileReferences() {
        ...
        expectedInstanceFile = this.getClass().getResource(References.negation3ExpectedInstance).getPath();
    }
}

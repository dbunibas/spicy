...
public class SQLQueryRSSimpleCoverage_300 extends SQLQueryTest {
    ...
    protected void initFileReferences() {
        ...
        sourceInstanceSQLScriptReader = new InputStreamReader(this.getClass().getResourceAsStream(References.rsSimpleCoverageSourceSQLScriptInstances_300));
        ...
        expectedInstanceFile = this.getClass().getResource(References.rsSimpleCoverageExpectedInstance_300).getPath();
    }
}

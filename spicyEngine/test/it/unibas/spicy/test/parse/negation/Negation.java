...
public class Negation extends MappingTaskTest {

    public void test1() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.negationExample).toURI()).getAbsolutePath();

...
package it.unibas.spicy.test.parse.negation;

import it.unibas.spicy.test.References;
import it.unibas.spicy.test.mappingtask.MappingTaskTest;
import java.io.File;

public class Negation2 extends MappingTaskTest {

    public void test1() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.negationExample2).toURI()).getAbsolutePath();

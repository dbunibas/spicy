...
public class Negation4 extends MappingTaskTest {

    public void test1() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.negationExample4).toURI()).getAbsolutePath();

...
public class TestMappingTaskRSNoCoverageRed extends MappingTaskTest {

    protected void setUp() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.RSNoCoverageRed).toURI()).getAbsolutePath();

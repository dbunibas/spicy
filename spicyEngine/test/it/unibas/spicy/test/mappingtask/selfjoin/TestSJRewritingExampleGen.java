...
public class TestSJRewritingExampleGen extends MappingTaskTest {

    protected IParseMappingTask generator = new ParseMappingTask();

    protected void setUp() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.sjRewritingExample).toURI()).getAbsolutePath();

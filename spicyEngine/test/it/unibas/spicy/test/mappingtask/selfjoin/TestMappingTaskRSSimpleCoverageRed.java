...
public class TestMappingTaskRSSimpleCoverageRed extends MappingTaskTest {

    protected void setUp() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.RSSimpleCoverageRed).toURI()).getAbsolutePath();

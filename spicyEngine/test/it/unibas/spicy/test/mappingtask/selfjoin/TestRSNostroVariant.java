...
public class TestRSNostroVariant extends MappingTaskTest {

    protected IParseMappingTask generator = new ParseMappingTask();

    public void setUp() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.rsNostroVariant).toURI()).getAbsolutePath();

...
public class TestMappingTask01Copying extends MappingTaskTest {

    protected void setUp() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.stBenchmarkCopying).toURI()).getAbsolutePath();

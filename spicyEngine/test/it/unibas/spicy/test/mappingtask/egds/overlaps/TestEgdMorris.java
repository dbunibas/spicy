...
package it.unibas.spicy.test.mappingtask.egds.overlaps;
...
import it.unibas.spicy.test.mappingtask.egds.MappingTaskEGDTest;
import java.io.File;
import java.util.List;

public class TestEgdMorris extends MappingTaskEGDTest {

    public void setUp() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.morris).toURI()).getAbsolutePath();
...
// students(studname: x0, birthdate: x1, ssn: x2) -->
//    persons(name: x0, birthdate: x1, ssn: x2, phone: N3).
//
// employees(empname: x4, ssn: x5, phone: x6) -->
//    persons(name: x4, birthdate: N7, ssn: x5, phone: x6).
    ...
    private void checkPersons(INode instanceNode) {
        ...
        assertEquals(4, personNodes.size());
        assertTrue(checkPerson("Maxwell", 1980, 12345, NullValueFactory.getNullValue(), personNodes));
        assertTrue(checkPerson("Morris", 1982, 10022, 3030, personNodes));

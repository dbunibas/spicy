...
public class TestChaseExample1Gen extends MappingTaskTest {

    protected IParseMappingTask generator = new ParseMappingTask();

    protected void setUp() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.chaseExample1).toURI()).getAbsolutePath();

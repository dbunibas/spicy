...
public class TestMappingTaskNestedST extends MappingTaskTest {

    protected void setUp() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.nestedST).toURI()).getAbsolutePath();

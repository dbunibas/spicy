...
public class TestMappingNeedsLab extends MappingTaskTest {
    ...
    protected void setUp() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.needsLab).toURI()).getAbsolutePath();

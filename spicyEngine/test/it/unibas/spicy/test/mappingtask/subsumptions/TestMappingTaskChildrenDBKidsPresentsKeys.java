...
public class TestMappingTaskChildrenDBKidsPresentsKeys extends MappingTaskTest {

    protected void setUp() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.childrenDBKidsPresentsKeys).toURI()).getAbsolutePath();

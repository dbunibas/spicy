...
public class TestParserAutomorphism extends MappingTaskTest {

    public void test() throws Exception {
        String mappingTaskFile = new File(this.getClass().getResource(References.automorphismTGD).toURI()).getAbsolutePath();
